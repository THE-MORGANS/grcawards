					...
					<div class="post-item-cover">
						...
						<div class="post-content">
							<div class="text" style="text-align: justify;">
								...
								<p><i class="mdi mdi-chevron-right mdi-18px"></i>
									The awards provide a platform for benchmarking organizations against industry peers, 
									facilitating knowledge sharing and setting benchmarks for excellence in GRC and FinCrime prevention.
								</p>
							</div>
						</div>
					</div>
