					...
					<div class="post-item-cover">
						...
						<div class="widget widget-archive">
							...
							<ul style="font-size:14px">
								...
								<li><i class="mdi mdi-chevron-right mdi-18px"></i>To create healthy competition amongst financial institutions in the area of promotin good governance system as well as effective risk management and compliance programs.</li>
