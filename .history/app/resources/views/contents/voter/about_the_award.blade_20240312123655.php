					...
					<div class="post-item-cover">
						...
						<div class="widget widget-archive">
							...
							<ul style="font-size:16px; text-align: justify">
								...
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0;">Benchmarking and Best Practices:</h6>
									<p>
								...
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0;">Employee Motivation and Retention:</h6>
									<p>
								...
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0;"><i class="mdi mdi-chevron-right mdi-18px"></i>Publtunities:</h6>
									<p>
										GRC and FinCrime awards provide organizations with valuable marketing opportunities, offering a platform to showcase their commitment to regulatory compliance, risk management, and financial crime prevention to a wider audience.
									</p>
								</li>
