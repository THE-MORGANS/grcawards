					...
					<div class="col-12" style="text-align:justify;">
						...
						<div class="mission-info-text">
							...
							<ul>
								<li>
									<p>
									Holistic Approach: Explore the interconnected realms of conflict, corruption, and cybersecurity, understanding how they influence and impact each other within the corporate environment.
