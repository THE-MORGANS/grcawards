				...
				<div class="row">
					...
					<div class="col-12" style="text-align:justify;">
						...
						<div class="mission-info-text">
							...
							<p class="p-3"></p>
							<h6 class="col-12 mb-1" style="padding-left:0;padding-right:0;">💡 Why Attend: </h6>
							<ul>
								<li>
									<p>
									<b>Holistic Approach:</b> Explore the interconnected realms of conflict, corruption, and cybersecurity, understanding how they influence and impact each other within the corporate environment.
									</p>
								</li>
							</ul>
