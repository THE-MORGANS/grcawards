        ...
        <form class="needs-validation" method="POST" action="{{route('admin.StoreNominessVotes',[request()->segment(3)])}}" id="form1">
            ...
            <div class="table-responsive">
                <table class="nominees-table">
                    <thead>
                        <tr>
                            <th style="width: 15%">Nominee Name</th>
                            <th style="width: 8%">Votes</th>
                            <th style="width: 8%">Percentage</th>
                            <th style="width: 12%">Innovation</th>
                            <th style="width: 12%">Customer Exp.</th>
                            <th style="width: 12%">Value for Money</th>
                            <th style="width: 12%">Scalability</th>
                            <th style="width: 11%">Adverse Media</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data-cell small text-muted">{{ $awp->innovation }}</td>
                            <td class="data-cell small text-muted">{{ $awp->custom_experience }}</td>
                            <td class="data-cell small text-muted">{{ $awp->value_for_money }}</td>
                            <td class="data-cell small text-muted">{{ $awp->scalability_integration }}</td>
