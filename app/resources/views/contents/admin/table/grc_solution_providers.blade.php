                            ...
                            <table class="nominees-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 12%">Software Provider Profile</th>
                                        <th style="width: 12%">GRC Areas Covered</th>
                                        <th style="width: 12%">Clients</th>
                                        <th style="width: 12%">Client Rating</th>
                                        <th style="width: 11%">Affiliations</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data-cell">{{ $awp->profile_of_the_software_provider }}</td>
                                        <td class="data-cell">{{ $awp->areas_of_grc_the_software_covers }}</td>
                                        <td class="data-cell">{{ $awp->clients_of_grc_software_providers }}</td>
                                        <td class="data-cell">{{ $awp->clients_rating_of_grc_software_provider }}</td>
