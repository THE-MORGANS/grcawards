                ...
                <table class="nominees-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 20%">Reporter Profile</th>
                            <th style="width: 20%">GRC & Anti-FinCrime Coverage</th>
                            <th style="width: 15%">Evidence of Work</th>
                            <th style="width: 14%">Judges Votes</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data-cell small text-muted">{{ $awp->areas_of_GRC_and_anti_FinCrime_the_Reporter_Covers }}</td>
