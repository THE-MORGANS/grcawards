                            ...
                            <table class="nominees-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data-cell">{{ $awp->profile_of_the_reporter }}</td>
                                        <td class="data-cell">{{ $awp->areas_of_GRC_and_anti_FinCrime_the_Reporter_Covers }}</td>
                                        <td class="data-cell">{{ $awp->Evidence_of_Reporter_Work }}</td>
                                        <td>
