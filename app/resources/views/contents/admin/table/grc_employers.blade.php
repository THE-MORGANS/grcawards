                            ...
                            <table class="nominees-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data-cell">{{ $awp->No_of_employees_who_rated }}</td>
                                        <td class="data-cell">{{ $awp->worklife_balance }}</td>
                                        <td class="data-cell">{{ $awp->pay_and_benefits }}</td>
                                        <td class="data-cell">{{ $awp->job_security_and_advancement }}</td>
                                        <td class="data-cell">{{ $awp->management }}</td>
                                        <td class="data-cell">{{ $awp->culture }}</td>
                                        <td class="data-cell">{{ $awp->average_rating }}</td>
                                        <td>
