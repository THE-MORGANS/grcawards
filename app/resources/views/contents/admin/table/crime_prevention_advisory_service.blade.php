                            ...
                            <table class="nominees-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data-cell">{{ $awp->profile_of_the_advisory_service_provider }}</td>
                                        <td class="data-cell">{{ $awp->evidence_of_innovative_ways_of_promoting }}</td>
                                        <td class="data-cell">{{ $awp->clients_of_advisory_services }}</td>
                                        <td class="data-cell">{{ $awp->client_rating_of_advisory_service_provider }}</td>
