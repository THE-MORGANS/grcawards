                ...
                <table class="nominees-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 20%">Board Composition</th>
                            <th style="width: 20%">Policies & Framework</th>
                            <th style="width: 15%">Add. Info</th>
                            <th style="width: 14%">Adverse Media</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data-cell small text-muted">{{ $awp->board_composition }}</td>
                            <td class="data-cell small text-muted">{{ $awp->policies_and_framework_in_place_enhancing_customer_experience }}</td>
                            <td class="data-cell small text-muted">{{ $awp->additional_information }}</td>
