                            ...
                            <table class="nominees-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data-cell">{{ $awp->board_composition }}</td>
                                        <td class="data-cell">{{ $awp->policies_and_framework_in_place_enhancing_customer_experience }}</td>
                                        <td class="data-cell">{{ $awp->additional_information }}</td>
