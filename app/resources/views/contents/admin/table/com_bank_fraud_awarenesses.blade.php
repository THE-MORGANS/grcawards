        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="header-title mb-4">Add Judges Votes for <span style="color:green"> {{$awards[0]->awards->name}} Awards </span> </h4>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-responsive table-hover table-striped  table-bordered mb-0">
                                            <thead>
                                                <tr style="background:yellow;">
                                                    ...
                                                    <th>Fraud Awareness</th>
                                                    <th>Fraud Prevention Policies</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="color:red; font-weight:600">  {{$awp->awards->name}} Awards</td>
                                                    <td>  {{$awp->nominee->name}}</td>
                                                    <td>
                                                        {{$awp->number_of_votes}}
                                                         </td>
                                                         <td>
                                                         {{number_format($awp->percentage_votes,2)}}%
                                                     </td>
                                                     <td>   {{$awp->fraud_awareness}} </td>
                                                     <td>   {{$awp->fraud_prevention_policies}} </td>
                                                     <td>   {{$awp->additional_information}} </td>
                                                     <td>   {{$awp->adverse_media}} </td>
                                                     <td> <input type="text" placeholder="Enter Vote"> </td>
