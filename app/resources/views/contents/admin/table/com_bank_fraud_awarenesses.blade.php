                            ...
                            <table class="nominees-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 20%">Fraud Awareness</th>
                                        <th style="width: 20%">Fraud Prevention Policies</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="data-cell">{{ $awp->fraud_awareness }}</td>
                                        <td class="data-cell">{{ $awp->fraud_prevention_policies }}</td>
