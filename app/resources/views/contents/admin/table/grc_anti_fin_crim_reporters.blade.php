                ...
                <table class="nominees-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 5%">%</th>
                            <th style="width: 15%">Reporter Profile</th>
                            <th style="width: 15%">GRC Areas Covered</th>
                            <th style="width: 12%">Evidence of Work</th>
                            <th style="width: 10%">Achievements</th>
                            <th style="width: 10%">Adverse Media</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data-cell small text-muted">{{ $awp->profile_of_the_reporter }}</td>
                            <td class="data-cell small text-muted">{{ $awp->areas_anti_fincrime_the_reporter_covers }}</td>
                            <td class="data-cell small text-muted">{{ $awp->evidence_of_reporter_work }}</td>
                            <td class="data-cell small text-muted">{{ $awp->achievements }}</td>
