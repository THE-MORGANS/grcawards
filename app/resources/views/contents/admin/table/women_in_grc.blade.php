                ...
                <table class="nominees-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 20%">Company & LinkedIn</th>
                            <th style="width: 20%">Professional Membership</th>
                            <th style="width: 15%">Adverse Media</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data-cell small text-muted">{{ $awp->Company_and_linkedin_profile_link }}</td>
