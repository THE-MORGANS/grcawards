                ...
                <table class="nominees-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 8%">Worklife Balance</th>
                            <th style="width: 8%">Comp. & Benefits</th>
                            <th style="width: 8%">Security & Adv.</th>
                            <th style="width: 8%">Management</th>
                            <th style="width: 8%">Culture</th>
                            <th style="width: 8%">Avg Rating</th>
                            <th style="width: 12%">Add. Info</th>
                            <th style="width: 12%">Adverse Media</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="nominee-name-cell">{{ $awp->nominee_name }}</td>
