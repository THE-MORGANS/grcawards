                ...
                <table class="nominees-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="data-cell small text-muted">{{ $awp->title }}</td>
                            <td class="data-cell small text-muted">
                            ...
                            <td class="data-cell small text-muted">{{ $awp->recognised_professional_association_membership }}</td>
                            <td class="data-cell small text-muted">{{ $awp->number_of_independent_non_executive_directors }}</td>
                            <td class="data-cell small text-muted">{{ $awp->board_committee_in_place_covering_risk_management }}</td>
                            <td class="data-cell small text-muted">{{ $awp->evidence_of_policy_on_fin_crime_prevention }}</td>
                            <td class="data-cell small text-muted">{{ $awp->aml_policy }}</td>
                            <td class="data-cell small text-muted">{{ $awp->adverse_media }}</td>
                            <td>
