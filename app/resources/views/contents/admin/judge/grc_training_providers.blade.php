                    ...
                    <form class="needs-validation" method="POST" action="{{route('admin.getNominessDetails',[request()->segment(3)])}}" id="form1">
                        ...
                        <div class="crit-field-grid">
                            <div class="crit-field is-full">
                                <label>Profile of the Training Provider and Areas of GRC Covered</label>
                            ...
                            <div class="crit-field is-full">
                                <label>Evidence of Innovative Ways of Teaching</label>
                            ...
                            <div class="crit-field">
                                <label>Clients of Training Providers</label>
                            ...
                            <div class="crit-field">
                                <label>Clients Rating of Training Provider</label>
