                    ...
                    <form class="needs-validation" method="POST" action="{{route('admin.getNominessDetails',[request()->segment(3)])}}" id="form1">
                        ...
                        <div class="crit-field-grid">
                            <div class="crit-field is-full">
                                <label>Board Composition - Number of independent non-executive directors and board committees in place covering Risk & Compliance</label>
                                <input class="form-control @error('board_composition') is-invalid @enderror" @if(isset($nominessDetails->board_composition)) value="{{$nominessDetails->board_composition}}" @endif placeholder="board composition" type="text" name="board_composition" />
                                @error('board_composition')
                                <span class="invalid-feedback d-block" role="alert"><strong>{{ $message }}</strong></span>
                                @enderror
                            </div>
                            <div class="crit-field is-full">
                                <label>Policies and Framework in Place Enhancing Customer Experience</label>
