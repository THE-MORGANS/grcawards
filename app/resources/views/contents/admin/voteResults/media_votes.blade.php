                ...
                <table class="awards-table results-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $awp->status == 'WINNER' ? 'bg-soft-success' : '' }}">
                            ...
                            <td style="min-width: 300px; max-width: 450px;" class="text-muted small">{{ $awp->profile_of_the_reporter }}</td>
                            <td style="min-width: 300px; max-width: 450px;" class="text-muted small">{{ $awp->areas_of_GRC_and_anti_FinCrime_the_Reporter_Covers }}</td>
                            <td style="min-width: 300px; max-width: 450px;" class="text-muted small">{{ $awp->Evidence_of_Reporter_Work }}</td>
