                ...
                <table class="awards-table results-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $awp->status == 'WINNER' ? 'bg-soft-success' : '' }}">
                            ...
                            <td class="score-cell">{{ $awp->No_of_employees_who_rated }}</td>
                            <td class="score-cell">{{ $awp->worklife_balance }}</td>
                            <td class="score-cell">{{ $awp->pay_and_benefits }}</td>
                            <td class="score-cell">{{ $awp->job_security_and_advancement }}</td>
                            <td class="score-cell">{{ $awp->management }}</td>
                            <td class="score-cell">{{ $awp->culture }}</td>
                            <td class="score-cell">{{ $awp->average_rating }}</td>
                            <td style="min-width: 250px;" class="text-muted small">{{ $awp->additional_information }}</td>
                            <td style="min-width: 250px;" class="text-muted small">{{ $awp->adverse_media }}</td>
