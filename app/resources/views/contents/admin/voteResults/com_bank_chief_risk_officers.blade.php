                ...
                <table class="awards-table results-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $awp->status == 'WINNER' ? 'bg-soft-success' : '' }}">
                            ...
                            <td class="score-cell">{{ $awp->names }}</td>
                            <td class="score-cell">{{ $awp->title }}</td>
                            <td style="min-width: 200px;" class="text-muted small">{{ $awp->profile_on_linkedIn }}</td>
                            <td style="min-width: 250px;" class="text-muted small">{{ $awp->recognised_professional_association_membership }}</td>
                            <td style="min-width: 250px;" class="text-muted small">{{ $awp->board_committee_in_place_covering_risk_management }}</td>
                            <td style="min-width: 250px;" class="text-muted small">{{ $awp->evidence_of_policy_on_fin_crime_prevention }}</td>
                            <td style="min-width: 250px;" class="text-muted small">{{ $awp->aml_policy }}</td>
                            <td style="min-width: 250px;" class="text-muted small">{{ $awp->documentation }}</td>
