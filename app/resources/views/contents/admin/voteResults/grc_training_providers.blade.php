                ...
                <table class="awards-table results-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $awp->status == 'WINNER' ? 'bg-soft-success' : '' }}">
                            ...
                            <td style="min-width: 300px; max-width: 450px;" class="text-muted small">{{ $awp->training_overview }}</td>
                            <td style="min-width: 300px; max-width: 450px;" class="text-muted small">{{ $awp->impact_and_feedback }}</td>
