                ...
                <table class="awards-table results-table mb-0">
                    <thead>
                        <tr>
                            ...
                            <th>Votes Cast</th>
                            <th>Votes %</th>
                            <th>Fraud Strategy</th>
                            <th>Policies & Framework</th>
                            <th>Add. Info</th>
                            <th>Adverse Media</th>
                            <th>Judges Total</th>
                            <th>Judges %</th>
                    ...
                    <tbody>
                        ...
                        <tr class="{{ $awp->status == 'WINNER' ? 'bg-soft-success' : '' }}">
                            ...
                            <td style="min-width: 300px; max-width: 400px;" class="text-muted small">{{ $awp->fraud_awareness_strategy }}</td>
                            <td style="min-width: 300px; max-width: 400px;" class="text-muted small">{{ $awp->policies_and_framework_in_place_enhancing_customer_experience }}</td>
