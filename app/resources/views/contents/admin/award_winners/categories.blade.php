...
<div class="container">
        ...
        <div class="col-12">
            <div class="page-title-box" style="margin-top: 20px; margin-bottom: 20px;">
                <div class="page-title">
                    ...
                    <h4 style="display: block;" class="text-muted fw-normal mt-0 mb-0">Award Year {{$currentYear?->year}} &middot; Overall Score = (Judges&nbsp;75%) + (Public&nbsp;Vote&nbsp;25%)</h4>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4 d-flex">
            <a href="{{route('admin.winners.sectors', ['award_program'=>$award_program, 'category_id'=>$category->hashid])}}" class="category-card-link">
                <div class="card category-card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <h6 class="category-eyebrow mb-0">Category</h6>
                            <span class="badge ms-1" style="padding:4px 8px; font-size:12px; white-space:nowrap; background:rgba(201,162,39,.15); color:#a4790f;">{{$category->award_count}} {{ Str::plural('award', $category->award_count) }}</span>
                        </div>
                        ...
                        <div class="category-footer">
                            ...
                            <span class="view-link">View Winners <i class="mdi mdi-arrow-right"></i></span>
                        </div>
                    </div>
                </div>
            </a>
