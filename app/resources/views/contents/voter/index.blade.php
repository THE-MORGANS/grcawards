	...
	<div class="page-preloader-cover">
		<div class="cssload-loader">
			<div class="cssload-inner">
				<img class="ball" src="https://res.cloudinary.com/the-morgans-consortium/image/upload/v1664067165/grcfincrimeawards/landing_page/grc_awards_summit_logo_y8nqdz.png" alt="GRC Awards & Summit" />
			</div>
		</div>
			...
			<div class="container">
				<div class="conference-counter-wrap">
					...
					<div class="conference-counter-cover">
						...
						<h3>Voting Now Closed for this year entries</h3>
