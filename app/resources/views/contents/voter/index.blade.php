    ...
    <div class="section-inner">
      ...
      <div class="ticket-grid">
        <div class="ticket-card">
          ...
          <a href="{{ route('awards_summit.payment', 'summit') }}" class="ticket-cta">Reserve Summit Pass</a>
        </div>
        ...
        <div class="ticket-card featured">
          ...
          <a href="{{ route('awards_summit.payment', 'full') }}" class="ticket-cta">Reserve Full Pass</a>
        </div>
        ...
        <div class="ticket-card">
          ...
          <a href="{{ route('awards_summit.payment', 'gala') }}" class="ticket-cta">Reserve Gala Pass</a>
        </div>
        ...
        <div class="ticket-card">
          ...
          <a href="{{ route('awards_summit.payment', 'student') }}" class="ticket-cta">Reserve Student Pass</a>
        </div>
      </div>
