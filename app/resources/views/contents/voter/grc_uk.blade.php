					...
					<div class="post-item-cover">
						...
						<div class="widget widget-archive">
							...
							<ul style="font-size:16px; text-align: justify">
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0; mdi mdi-chevron-right"><i class="mdi mdi-chevron-right mdi-18px"></i> ✔️ Europe & UK GRC Leadership Award </h6>
									{{-- <p>
								...
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0;"><i class="mdi mdi-chevron-right mdi-18px"></i>✔️ Financial Crime Prevention Champion</h6>
									{{-- <p>
								...
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0;"><i class="mdi mdi-chevron-right mdi-18px"></i>✔️ Best Risk & Compliance Framework</h6>
									{{-- <p>
								...
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0;"><i class="mdi mdi-chevron-right mdi-18px"></i>✔️ Cybersecurity & Fraud Prevention Excellence:</h6>
									{{-- <p>
								...
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0;"><i class="mdi mdi-chevron-right mdi-18px"></i>✔️ Women in GRC Leadership Award:</h6>
									{{-- <p>
								...
								<li>
									<h6 class="col-12" style="padding-left:0;padding-right:0;"><i class="mdi mdi-chevron-right mdi-18px"></i>✔️ Young Professional in GRC & Financial Crime Prevention …and more!</h6>
									{{-- <p>
