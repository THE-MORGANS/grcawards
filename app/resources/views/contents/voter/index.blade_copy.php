...
<head>
	<meta charset="utf-8" />
	<title>Africa Edition — GRC &amp; Financial Crime Prevention Awards &amp; Summit 2026 | Nairobi | GRC & FinCrime Prevention Awards & Summit</title>
	...
	<meta content="GRC & FinCrime Prevention Awards & Summit" name="author" />
	<!-- App favicon -->
	...
	<!-- =================== STYLE =================== -->
	<!-- <link rel="stylesheet" type="text/css" href="https://grcfincrimeawards.com/assets/css/slick.min.css" /> -->
	<link rel="stylesheet" href="https://grcfincrimeawards.com/assets/css/bootstrap-grid.css" />
	<link rel="stylesheet" href="https://grcfincrimeawards.com/assets/css/icons.min.css" />
	<link rel="stylesheet" href="https://grcfincrimeawards.com/assets/css/style.css" />
	<link rel="stylesheet" href="https://grcfincrimeawards.com/assets/css/modal.css" />
	...
	<style>
		...
		*::after {
		...
		.hero-edition-flag {
			...
			gap: 10px;
			padding: 8px 18px;
			border: 1px solid rgba(197, 136, 30, 0.4);
			background: rgba(197, 136, 30, 0.08);
			margin-bottom: 32px;
			font-family: var(--font-mono);
			font-size: 11px;
		...
		.session-tag {
			...
			text-transform: uppercase;
			color: var(--teal);
			background: rgba(10, 107, 96, 0.08);
			padding: 3px 8px;
			margin-top: 6px
		}
		...
		.judging-box {
			...
			padding: 32px 36px;
			background: rgba(255, 255, 255, 0.04);
			border: 1px solid rgba(197, 136, 30, 0.15);
			display: flex;
			gap: 32px;
			align-items: start;
			flex-wrap: wrap
		...
		@keyframes pulse {
			...
			0%,
			100% {
				box-shadow: 0 0 0 0 rgba(80, 200, 80, 0.3)
			}

			50% {
				box-shadow: 0 0 0 12px rgba(80, 200, 80, 0)
			}
		}
		...
		.vb-deadline {
			...
			flex-shrink: 0;
			padding: 0 24px;
			border-left: 1px solid rgba(80, 200, 80, 0.2);
			border-right: 1px solid rgba(80, 200, 80, 0.2);
		}
		...
		.ps-status.done .ps-status-dot {
			background: rgba(255, 255, 255, 0.2)
		}

		.ps-status.active .ps-status-dot {
			background: #80D860;
			animation: blink 1.2s infinite
		}

		.ps-status.upcoming .ps-status-dot {
		...
		.process-step.done .ps-title {
			color: rgba(255, 255, 255, 0.4)
		}

		.process-step.active .ps-title {
			color: #FFFFFF
		}

		.process-step.upcoming .ps-title {
			color: rgba(255, 255, 255, 0.3)
		}
		...
		.process-step.done .ps-dates {
			color: rgba(255, 255, 255, 0.2);
			text-decoration: line-through;
			text-decoration-color: rgba(255, 255, 255, 0.1)
		}

		.process-step.active .ps-dates {
			color: #80D860
		}

		.process-step.upcoming .ps-dates {
			color: rgba(255, 255, 255, 0.2)
		}
		...
		.process-step.done .ps-body {
			color: rgba(255, 255, 255, 0.2)
		}

		.process-step.active .ps-body {
			color: rgba(255, 255, 255, 0.65)
		}

		.process-step.upcoming .ps-body {
			color: rgba(255, 255, 255, 0.2)
		}
		...
		.process-step.done .ps-check {
			background: rgba(255, 255, 255, 0.04);
			color: rgba(255, 255, 255, 0.2)
		}

		.process-step.active .ps-check {
			background: rgba(80, 200, 80, 0.12);
			color: #80D860
		}

		.process-step.upcoming .ps-check {
			background: rgba(255, 255, 255, 0.03);
		...
		.keynote-card.second::before {
			background: linear-gradient(90deg, var(--teal), var(--gold))
		}

		.keynote-card.third::before {
		...
		.kc-avatar.second {
			background: linear-gradient(145deg, rgba(10, 107, 96, 0.3), rgba(197, 136, 30, 0.15));
			border-color: rgba(10, 107, 96, 0.4);
			color: var(--teal)
		}

		.kc-avatar.third {
			background: linear-gradient(145deg, rgba(168, 81, 30, 0.3), rgba(232, 168, 58, 0.15));
			border-color: rgba(168, 81, 30, 0.4);
			color: var(--amber)
		}
		...
		.kc-topic.third {
			...
			background: rgba(168, 81, 30, 0.06)
		}
		...
		.kc-topic.second .kc-topic-label {
			color: var(--teal)
		}

		.kc-topic.third .kc-topic-label {
			color: var(--amber)
		}
		...
		.pc-sector-tag.banking {
			background: rgba(197, 136, 30, 0.15);
			color: var(--amber)
		}

		.pc-sector-tag.fintech {
			background: rgba(10, 107, 96, 0.15);
			color: var(--teal)
		}

		.pc-sector-tag.regulatory {
			background: rgba(11, 28, 58, 0.3);
			color: #8FA8C4
		}

		.pc-sector-tag.insurance {
			background: rgba(168, 81, 30, 0.15);
			color: var(--terracotta)
		}

		.pc-sector-tag.legal {
			background: rgba(197, 136, 30, 0.1);
			color: var(--gold)
		}

		.pc-sector-tag.academia {
			background: rgba(255, 255, 255, 0.08);
			color: rgba(255, 255, 255, 0.5)
		}

		.pc-sector-tag.regtech {
			background: rgba(10, 107, 96, 0.12);
			color: var(--teal)
		}

		.pc-sector-tag.investigations {
			background: rgba(168, 81, 30, 0.12);
			color: var(--amber)
		}

		.pc-sector-tag.energy {
			background: rgba(220, 130, 0, 0.15);
			color: #E8A020
		}

		.pc-sector-tag.manufacturing {
			background: rgba(100, 120, 80, 0.2);
			color: #90B060
		}

		.pc-sector-tag.engineering {
			background: rgba(60, 100, 160, 0.18);
			color: #80AADD
		}

		.pc-sector-tag.telecoms {
			background: rgba(80, 40, 120, 0.2);
			color: #B080E0
		}

		.pc-sector-tag.healthcare {
			background: rgba(0, 120, 100, 0.15);
			color: #40C8A8
		}

		.pc-sector-tag.public {
			background: rgba(140, 60, 60, 0.18);
			color: #D08080
		}

		.pc-sector-tag.aviation {
			background: rgba(40, 80, 140, 0.18);
			color: #7090C8
		}

		.pc-sector-tag.transport {
			background: rgba(80, 80, 40, 0.2);
			color: #B0A860
		}
		...
		.pl-avatar.banking {
			background: rgba(197, 136, 30, 0.1);
			border: 1px solid rgba(197, 136, 30, 0.25);
			color: var(--amber)
		}

		.pl-avatar.fintech {
			background: rgba(10, 107, 96, 0.1);
			border: 1px solid rgba(10, 107, 96, 0.25);
			color: var(--teal)
		}

		.pl-avatar.regulatory {
			background: rgba(143, 168, 196, 0.08);
			border: 1px solid rgba(143, 168, 196, 0.2);
			color: #8FA8C4
		}

		.pl-avatar.insurance {
			background: rgba(168, 81, 30, 0.1);
			border: 1px solid rgba(168, 81, 30, 0.25);
			color: var(--terracotta)
		}
		...
		.pl-avatar.investigations {
			background: rgba(168, 81, 30, 0.08);
			border: 1px solid rgba(168, 81, 30, 0.2);
			color: var(--amber)
		}

		.pl-avatar.energy {
			background: rgba(220, 130, 0, 0.08);
			border: 1px solid rgba(220, 130, 0, 0.2);
			color: #E8A020
		}

		.pl-avatar.manufacturing {
			background: rgba(100, 120, 80, 0.08);
			border: 1px solid rgba(100, 120, 80, 0.2);
			color: #90B060
		}

		.pl-avatar.engineering {
		...
		.pl-avatar.healthcare {
			background: rgba(0, 120, 100, 0.08);
			border: 1px solid rgba(0, 120, 100, 0.2);
			color: #40C8A8
		}
		...
		.pl-avatar.transport {
			background: rgba(80, 80, 40, 0.08);
			border: 1px solid rgba(80, 80, 40, 0.2);
			color: #B0A860
		}
		...
		.ticket-card.featured .ticket-includes li {
			color: rgba(255, 255, 255, 0.85)
		}
		...
		.ticket-card.featured .ticket-includes li::before {
			color: var(--gold)
		}
		...
		.site-footer {
			...
			border-top: 1px solid rgba(197, 136, 30, 0.15)
		}
		...
		@media(max-width:980px) {
			...
			.vb-deadline {
				border-left: none;
				border-right: none;
				border-top: 1px solid rgba(80, 200, 80, 0.2);
				padding: 16px 0 0;
				width: 100%;
				text-align: left
			}
...
<body>
		...
		<div class="container">
			<div class="row conference-header-row">
				<div class="col-sm-2 col-lg-2 col-xl-2">
					<a href="https://grcfincrimeawards.com" class="logo">
						<img src="https://grcfincrimeawards.com/assets/images/grclogo.png" loading="lazy" alt="GRC & FinCrime Awards and Summit" style="height: 80px;width: 80px;position:absolute;margin-top: -20px;" />
					</a>
				</div>
					...
					<nav class="nav-menu menu">
						<ul class="nav-list">
							<li class="active-page">
								<a href="https://grcfincrimeawards.com">home</a>
							</li>
							<li class="dropdown ">
								<a href="#">The Award
								...
								<ul>
									<li class=""><a href="https://grcfincrimeawards.com/the-award/about-the-award">about the award</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/vision-mission-statement">Vision and Mission Statement</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/the-award/sectors-and-categories">Categories</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/the-award/contact-us">Contact us</a></li>
								</ul>
							</li>
							...
							<li class="dropdown ">
								...
								<ul>
									<li class=""><a href="https://grcfincrimeawards.com/summit/mid-year-2026">Mid Year Summit 2026</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/summit/grc-summit-2026">GRC Summit 2026</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/summit/wigrc-2026">WGRCFP Summit 2026</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/summit">Summit 2025</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/summit/2024">Summit 2024</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/summit/2023">Summit 2023</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/summit/2022">Summit 2022</a></li>
								</ul>
							</li>
							...
							<li class="dropdown ">
								...
								<ul>
									...
									<li class=""><a href="https://grcfincrimeawards.com/winners/2025">2025 Winners</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/winners/2024?2024">2024 Winners</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/winners/2023?2023">2023 Winners</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/winners/2022?2022">2022 Winners</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/winners/2021?2021">2021 Winners</a></li>


								</ul>
							</li>
							<li class="">
								<a href="https://grcfincrimeawards.com/vote">vote</a>

							</li>
							<li class=""><a href="https://grcfincrimeawards.com/advisory/governing-council">Advisory Council </a></li>
							<li class="dropdown ">
								<a href="#">Judges <i class="mdi mdi-chevron-down" aria-hidden="true"></i></a>
								<ul>
									<li class=""><a href="https://grcfincrimeawards.com/judges/meet-our-judges">Awards Judges</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/judges/judging-process">Judging Process</a></li>
								</ul>
							</li>
							<li class="">
								<a href="https://grcfincrimeawards.com/sponsors">sponsors </a>
							...
							<li class="dropdown ">
								...
								<ul>
									<li><a class="" href="https://grcfincrimeawards.com/media/pictures">Pictures</a></li>
									<li><a href="#">Videos</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/media/press-announcements">Press Announcement</a></li>
								</ul>
							</li>
							<li class="dropdown ">
								<a href="#">others <i class="mdi mdi-chevron-down" aria-hidden="true"></i></a>
								<ul>
									<li class=""> <a href="https://grcfincrimeawards.com/code-of-conduct">Code of Conduct </a> </li>
									<li class=""><a href="https://grcfincrimeawards.com/others/faqs">FAQs</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/others/terms-and-conditions">Terms & Conditions</a></li>
									<li class=""><a href="https://grcfincrimeawards.com/others/privacy-policy">Privacy Policy</a></li>
								</ul>
							</li>
						</ul>
					</nav>
	...
	<section class="facts-strip">
		<div class="facts-inner">
			<div class="fact">
				<div class="fact-val">7th</div>
				<div class="fact-lbl">Annual<br>Edition</div>
			</div>
			<div class="fact">
				<div class="fact-val">8</div>
				<div class="fact-lbl">Summit<br>Sessions</div>
			</div>
			<div class="fact">
				<div class="fact-val">6</div>
				<div class="fact-lbl">Award<br>Pillars</div>
			</div>
			<div class="fact">
				<div class="fact-val">2020</div>
				<div class="fact-lbl">Founded<br>in Lagos</div>
			</div>
			<div class="fact">
				<div class="fact-val">200</div>
				<div class="fact-lbl">Guests<br>(Target)</div>
			</div>
		</div>
	</section>
				...
				<div class="amenity-tabs-grid">
					<div class="amenity-group">
						...
						<div class="amenity-item">
							<div class="am-name">Restaurants & cafés in Upper Hill & Hurlingham</div>
							<div class="am-dist">5–10 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Yaya Centre (shopping & dining)</div>
							<div class="am-dist">~10 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Westlands dining & nightlife district</div>
							<div class="am-dist">~20 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Hotel restaurants & lounge bar (on-site)</div>
							<div class="am-dist">On-site</div>
						</div>
					</div>
					...
					<div class="amenity-group">
						...
						<div class="amenity-item">
							<div class="am-name">Galleria Shopping Mall</div>
							<div class="am-dist">~25 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Yaya Centre</div>
							<div class="am-dist">~10 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Two Rivers Mall</div>
							<div class="am-dist">~35 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">The Hub, Karen</div>
							<div class="am-dist">~25–30 min drive</div>
						</div>
					</div>
					...
					<div class="amenity-group">
						...
						<div class="amenity-item">
							<div class="am-name">Nairobi National Park</div>
							<div class="am-dist">~20 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Giraffe Centre</div>
							<div class="am-dist">~25 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">David Sheldrick Wildlife Trust</div>
							<div class="am-dist">~25 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Karen Blixen Museum</div>
							<div class="am-dist">~30 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">National Museum of Kenya</div>
							<div class="am-dist">~15 min drive</div>
						</div>
					</div>
					...
					<div class="amenity-group">
						...
						<div class="amenity-item">
							<div class="am-name">Uhuru Park</div>
							<div class="am-dist">~10 min walk</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Nairobi Arboretum</div>
							<div class="am-dist">~15 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Kenya Railway Golf Club</div>
							<div class="am-dist">~5 min drive</div>
						</div>
						<div class="amenity-item">
							<div class="am-name">Royal Nairobi Golf Club</div>
							<div class="am-dist">~10 min drive</div>
						</div>
					</div>
				</div>
		...
		<div class="section-inner">
			...
			<div class="ticket-grid">
				<div class="ticket-card">
					...
					<div class="ticket-price">USD 100<span> / KES 13,000</span></div>
					...
					<a href="https://grcfincrimeawards.com/awards-summit/reserve/summit" class="ticket-cta">Reserve Summit Pass</a>
				</div>

				<div class="ticket-card featured">
					<div class="ticket-badge">Most Popular</div>
					<div class="ticket-name">Full Delegate Pass</div>
					<div class="ticket-price">USD 250<span style="color:rgba(255,255,255,0.4)"> / KES 32,500</span></div>
					...
					<a href="https://grcfincrimeawards.com/awards-summit/reserve/full" class="ticket-cta">Reserve Full Pass</a>
				</div>
				...
				<div class="ticket-card">
					...
					<a href="https://grcfincrimeawards.com/awards-summit/reserve/gala" class="ticket-cta">Reserve Gala Pass</a>
				</div>
				...
				<div class="ticket-card">
					...
					<a href="https://grcfincrimeawards.com/awards-summit/reserve/student" class="ticket-cta">Reserve Student Pass</a>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				<div class="footer-cont col-12 col-sm-6 col-lg-4">
					<a href="index.html" class="logo"><img style="height: 100px;width: 100px;" src="https://grcfincrimeawards.com/assets/images/grclogo.png" alt="logo"></a>
					...
					<p class="footer-copyright" style="color:#8b8b8b;">
						<a target="_blank" href="https://morgansconsortium.com" style="color: #D4AF37;">The Morgans Consortium</a> © 2026. All Rights Reserved.
					</p>
				</div>
				<div class="footer-item-link col-12 col-sm-6 col-lg-4" style="flex-direction: column;justify-content:space-evenly">
					<div class="footer-link">
						...
						<ul>
							<li><a href="https://grcfincrimeawards.com/the-award/about-the-award">About The Award</a></li>
							<li><a href="https://grcfincrimeawards.com/the-award/sectors-and-categories">Sectors & Categories</a></li>
							<li><a href="https://grcfincrimeawards.com/the-award/contact-us">Contact us</a></li>
						</ul>
					</div>
					...
					<div class="footer-link">
						...
						<ul>
							<li><a href="https://grcfincrimeawards.com/sponsors">Our Sponsors</a></li>
							<li><a href="https://grcfincrimeawards.com/sponsors#sponsorshipPackages">Sponsorship Packages</a></li>
							<li><a href="https://grcfincrimeawards.com/sponsors#becomeASponsor">Why Become a sponsor?</a></li>
						</ul>
					</div>
				...
				<div class="footer-subscribe col-12 col-sm-6 col-lg-4">
					...
					<p>By clicking the button you agree to the <a href="https://grcfincrimeawards.com/others/privacy-policy" target="_blank">Privacy Policy</a> and <a href="https://grcfincrimeawards.com/others/terms-and-conditions" target="_blank">Terms and Conditions</a></p>
				</div>
			</div>
		</div>
	</footer>
	<script src="https://grcfincrimeawards.com/assets/js/jquery-2.2.4.min.js"></script>
	<script src="https://grcfincrimeawards.com/assets/js/slick.min.js"></script>
	<script src="https://grcfincrimeawards.com/assets/js/rx-lazy.js"></script>
	<script src="https://grcfincrimeawards.com/assets/js/parallax.min.js"></script>
	<script src="https://grcfincrimeawards.com/assets/js/scripts.js"></script>
	<link rel="stylesheet" href="https://grcfincrimeawards.com/assets/js/modal.js" />
	<!-- Meta Pixel Code -->
	...
	<noscript><img height="1" width="1" style="display:none"
			src="https://www.facebook.com/tr?id=2392242014282784&ev=PageView&noscript=1" /></noscript>
	<!-- End Meta Pixel Code -->
</body>
