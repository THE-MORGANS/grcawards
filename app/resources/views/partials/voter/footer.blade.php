    ...
    <div class="container">
        <div class="row">
            <div class="footer-cont col-12 col-sm-6 col-lg-4">
                <a href="index.html" class="logo"><img style="height: 100px;width: 100px;" src="https://res.cloudinary.com/the-morgans-consortium/image/upload/v1664067165/grcfincrimeawards/landing_page/grc_awards_summit_logo_y8nqdz.png" alt="logo"></a>
