...
class CreateSectorsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $sectors = [
            ...
            ['name'=> 'Woman in Governance, Risk & Compliance', 'category_id'=>10, 'award_program_id' => 2,'created_at' => now(),'updated_at' => now()],
            ['name'=> 'Woman in Financial Crime Prevention', 'category_id'=>10, 'award_program_id' => 2,'created_at' => now(),'updated_at' => now()],
