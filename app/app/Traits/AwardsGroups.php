...
// --------------------in use -----------------
        ...
        $data['award_group_three'] = [105,107,109,126,133,135,129,137, 146, 131]; //com_bank_chief_risk_officers
        $data['award_group_four'] = [125, 104, 106,108,110,111,128,130, 132,134, 136]; //grc_employers
